...
python pruning.py      # Prune and fine-tune (~1 min)
...
Pruned (float32)            ~97.5%        ~300ms      215 KB
```
...
- **Pruning** alone does not reduce file size or speed without a sparse-aware runtime
